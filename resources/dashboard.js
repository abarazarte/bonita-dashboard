...
appModule.controller('TaskListController', 
	...
	this.tableHeaders = [
		{ name: 'displayName',	label : 'Nombre de la Tarea',	isSortable : true},
		{ name: 'procDefName',	label : 'Aplicación',		isSortable : true},
		{ name: 'doIt',			label : 'Hacer',		isSortable : false}
	];
...
appModule.controller('AppListController', 
	...
	this.isDescendingSort = false;
	this.tableHeaders = [
		{ name: 'displayName',	label : 'Nombre',		isSortable : true},
		{ name: 'version',		label : 'Versión',		isSortable : true},
		{ name: 'startIt',		label : 'Iniciar',		isSortable : false}
	];
...
function getCountLabel(controller) {
	...
	return 'Mostrando del '+ (startIndex+1) +' al '+ endIndex +' de '+ controller.list.totalCount;
}
